...
public class ImageEditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_edit_app);
        initView();
    }
    ...
    private void openAblum() {
        ImageEditActivity.this.startActivityForResult(new Intent(
                        ImageEditActivity.this, SelectPictureActivity.class),
