...
public class FragmentDataGenerator {
     ...
     * @return
     */
    public static Fragment[] getMainFragments(FragmentManager fragmentManager) {
        ...
        fragments[BottomNavigationEnum.HOME.getNavigationItemIndex()] = homeFragment;
        fragments[BottomNavigationEnum.GALLERY.getNavigationItemIndex()] = galleryFragment;
        fragments[BottomNavigationEnum.RESOURCE.getNavigationItemIndex()] = resourceFragment;
        return fragments;
    }
