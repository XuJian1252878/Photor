...
public class Matrix3Mul3 {
	...
	public Matrix3Mul3(float[] values) {
		this();
		setValues(values);
	}
	...
	public Matrix3Mul3 copy() {
		return new Matrix3Mul3(getValues());
	}
	 ...
	 * @param m
	 */
	public void multiply(Matrix3Mul3 m) {
	 ...
	 * @return
	 */
	public Matrix3Mul3 inverseMatrix() {
