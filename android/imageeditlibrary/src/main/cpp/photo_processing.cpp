...
// int
extern "C"
JNIEXPORT jint JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeInitBitmap(JNIEnv* env, jobject thiz, jint width, jint height) {
	return initBitmapMemory(&bitmap, width, height);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeGetBitmapRow(JNIEnv* env, jobject thiz, jint y, jintArray pixels) {
	int cpixels[bitmap.width];
	getBitmapRowAsIntegers(&bitmap, (int)y, (int*)(&cpixels));
	env->SetIntArrayRegion(pixels, 0, bitmap.width, cpixels);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeSetBitmapRow(JNIEnv* env, jobject thiz, jint y, jintArray pixels) {
	int cpixels[bitmap.width];
	env->GetIntArrayRegion(pixels, 0, bitmap.width, cpixels);
	setBitmapRowFromIntegers(&bitmap, (int)y, (int*)(&cpixels));
}

// int
extern "C"
JNIEXPORT jint JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeGetBitmapWidth(JNIEnv* env, jobject thiz) {
	return bitmap.width;
}

// int
extern "C"
JNIEXPORT jint JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeGetBitmapHeight(JNIEnv* env, jobject thiz) {
	return bitmap.height;
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeDeleteBitmap(JNIEnv* env, jobject thiz) {
	deleteBitmap(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeFlipHorizontally(JNIEnv* env, jobject thiz) {
	flipHorizontally(&bitmap, 1, 1, 1);
}

// int
extern "C"
JNIEXPORT jint JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeRotate90(JNIEnv* env, jobject thiz) {
...
// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeRotate180(JNIEnv* env, jobject thiz) {
	rotate180(&bitmap, 1, 1, 1);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyInstafix(JNIEnv* env, jobject thiz) {
	applyInstafix(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyAnsel(JNIEnv* env, jobject thiz) {
	applyAnselFilter(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyTestino(JNIEnv* env, jobject thiz) {
	applyTestino(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyXPro(JNIEnv* env, jobject thiz) {
	applyXPro(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyRetro(JNIEnv* env, jobject thiz) {
	applyRetro(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyBW(JNIEnv* env, jobject thiz) {
	applyBlackAndWhiteFilter(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplySepia(JNIEnv* env, jobject thiz) {
	applySepia(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyCyano(JNIEnv* env, jobject thiz) {
	applyCyano(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyGeorgia(JNIEnv* env, jobject thiz) {
	applyGeorgia(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplySahara(JNIEnv* env, jobject thiz) {
	applySahara(&bitmap);
}

// void
extern "C"
JNIEXPORT void JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyHDR(JNIEnv* env, jobject thiz) {
	applyHDR(&bitmap);
}

// int
extern "C"
JNIEXPORT jint JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeLoadResizedJpegBitmap(JNIEnv* env, jobject thiz, jbyteArray bytes, jint jpegSize, jint maxPixels) {
	char* jpegData = (char*) env->GetPrimitiveArrayCritical(bytes, NULL);
	...
	env->ReleasePrimitiveArrayCritical(bytes, jpegData, 0);
...
// int
extern "C"
JNIEXPORT jint JNICALL Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeResizeBitmap(JNIEnv* env, jobject thiz, jint newWidth, jint newHeight) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_xinlan_imageeditlibrary_editimage_task_ImageProcessingTask_nativeApplyFilter(JNIEnv *env,
                                                                          jclass type,
                                                                          jint mode,
                                                                          jint val,
                                                                          jlong inpAddr,
